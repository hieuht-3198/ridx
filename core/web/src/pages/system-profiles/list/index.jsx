...
import { ModalForm, ProFormText, ProFormTextArea, ProForm, EditableProTable } from '@ant-design/pro-form';
import { PageContainer } from '@ant-design/pro-layout';
import ProTable from '@ant-design/pro-table';
import { Button, Col, Form, Input, message, Modal, Row, Space } from 'antd';
import React, { useRef, useState } from 'react';
import { getSystemProfiles, deleteSystemProfile, createSystemProfile, updateSystemProfile } from './service';
...
const SystemProfiles = () => {
  ...
  const handleAddEditSystemProfile = async (values) => {
    ...
    const res = isAddSystemProfile ? await createSystemProfile(sendData) : await updateSystemProfile(currentRow.id, sendData)
    if (res) {
