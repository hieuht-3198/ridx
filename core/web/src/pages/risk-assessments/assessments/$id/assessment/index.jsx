import { convertImpactToNumber, likelihoodToType, likelihoodTypeToColor, riskLevelToType, severityToType, severityTypeToColor, toFixNumber } from '@/shared/common'
import { CRITICAL_COLOR, HIGH_COLOR, LOW_COLOR, MEDIUM_COLOR, NODE_CPT, NODE_DECISION, NODE_DECISION_TRUE, RISK_LEVEL_LIST, RISK_MATRIX } from '@/shared/constant'
import { Bar, Scatter, Heatmap } from '@ant-design/charts'
import { CheckCircleOutlined, CheckOutlined, CloseCircleOutlined, CloseOutlined, LoadingOutlined } from '@ant-design/icons'
    ...
    const handleClickButtonStartAssessment = async () => {
        try {
            ...
            if (assessmentRes) {
                ...
                const l_n = likelihoodToType(assessmentRes.data.likelihood.not_countermeasures.outcomes[NODE_DECISION_TRUE])
                const l_i = likelihoodToType(assessmentRes.data.likelihood.countermeasures.outcomes[NODE_DECISION_TRUE])
                setDataSystem([
                    {
                        attribute: 'Severity',
