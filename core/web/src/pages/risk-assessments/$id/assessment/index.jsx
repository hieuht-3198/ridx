...
import { CRITICAL_COLOR, HIGH_COLOR, LOW_COLOR, MEDIUM_COLOR, NODE_DECISION, NODE_DECISION_TRUE, RISK_MATRIX } from '@/shared/constant'
import { Scatter, Heatmap } from '@ant-design/charts'
...
const ResultDetail = ({ riskAssessmentReport }) => {
    ...
    const handleClickButtonStartAssessment = () => {
        ...
        const l_n = assessmentRes?.data?.likelihood?.not_countermeasures
        const l_i = assessmentRes?.data?.likelihood?.countermeasures
        setDataSystem([
            {
                attribute: 'Severity',
