			...
			content={
                <Descriptions column={1} style={{ marginBottom: -16 }}>
                    <Descriptions.Item label="For deployment scenario">
                        <a
                            onClick={() => {
                                history.push(`/deployment-scenarios/${riskAssessmentReport?.deployment_scenario.id}`)
                            }}
                        >
