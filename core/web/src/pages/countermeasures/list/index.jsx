...
import { getCountermeasures, deleteCountermeasure, createCountermeasure, updateCountermeasure } from './service';
...
const Countermeasures = () => {
  ...
  const handleAddEditCountermeasure = async (values) => {
    ...
    const res = isAddCountermeasure ? await createCountermeasure(sendData) : await updateCountermeasure(currentRow.id, sendData)
    if (res) {
